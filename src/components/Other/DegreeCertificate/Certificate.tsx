...
//                     <p>
//                         {/* Bergisch Gladbach Freiburg */}
//                         The President and Fellows of Bergisch Gladbach Freiburg College, with the consent of the Honorable and Reverend Board of
...
//                     the University on this twenty-sixth day of July in the Year of Our Lord two thousand and nineteen and of
//                     Bergisch Gladbach Freiburg University the eleventh.
//                 </p>

//                 <div className="degree-certificate-footer d-flex justify-content-between align-items-end mt-5">
//                     <p className="fw-bold text-center flex-fill position-relative pb-4">PRESIDENT</p>
