    ...
    <div>
      ...
      <div className="about-us-container">
        ...
        <div className="centered-content">
          <h1>The People of Bergisch Gladback Freiburg University</h1>
          <p>Our community is what makes Bergisch Gladback Freiburg University unique. Through ongoing
            efforts to foster inclusion and belonging, Bergisch Gladback Freiburg has created a diverse
        ...
        <section className="our-numbers">
          ...
          <ul>
            <li><span>2459</span> Undergraduate and Graduate Students</li>
            <li><span>150</span> Faculty and Staff</li>
            <li><span>14,000+</span> Alumni Worldwide</li>
        ...
        <section className="our-beliefs">
          <p>
            ...
            <br /><br />
            <strong>President of Bergisch Gladback Freiburg University</strong>
            <br />
            Dr. Eleanor M. Hayes
          </p>
        ...
        <div className="horizontal-container">
          <section className="president-info">
            <h2>President of Bergisch Gladback Freiburg University</h2>
            <p>Dr. Eleanor M. Hayes</p>
          </section>

          <section className="president-ehrenfeld">
            <h2>President of Universität Ehrenfeld</h2>
            <p>Dr. Johann F. Müller serves as the 12th President of Universität Ehrenfeld.</p>
          </section>

          <section className="deans-and-officers">
            <h2>Deans and Officers</h2>
            <p>Leading Universität Ehrenfeld's faculties and administrative divisions.</p>
          </section>

          <section className="Bergisch Gladback Freiburg-corporation">
            <h2>Bergisch Gladback Freiburg Corporation</h2>
          ...
          <section className="board-of-advisors">
            ...
            <p>Distinguished alumni dedicated to advancing Bergisch Gladback Freiburg University's mission and vision.</p>
          </section>
        </div>
