import BGFBTCSE00088385 from './BGFBTCSE00088385.json';
...
const BTech_MarksSheetA4 = () => {
  const { studentDetails, semesters }: Data = BGFBTCSE00088385;
...
export default BTech_MarksSheetA4;
